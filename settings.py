...
openai = {
    ...
    "REALTIME_MODEL_ENDPOINT": "wss://api.openai.com/v1/realtime?model=gpt-4o-realtime-preview",
    "REALTIME_TRANSCRIPT_MODEL_ENDPOINT": "https://api.openai.com/v1/realtime/transcription_sessions"
}
